export default function Button({ type = "button", variant = "primary", children, onClick, disabled = false }) {
  const baseStyle =
    "w-full px-4 py-2 rounded text-button-size text-button-line focus:outline-none focus:ring-2 transition";

  const variantStyle = {
    primary: "bg-primary text-neutral hover:bg-primary-darken focus:ring-info",
    outline: "border border-info text-info hover:bg-info-darken focus:ring-blue-500",
